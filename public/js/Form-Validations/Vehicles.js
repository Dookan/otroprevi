...
vehicle_brand.addEventListener('keyup', () => {
    if (vehicle_brand.value === '' || vehicle_brand.value == null || vehicle_brand.value.length < 2) {
...
vehicle_model.addEventListener('keyup', () => {
    if (vehicle_model.value === '' || vehicle_model.value == null || vehicle_model.value.length < 2) {
