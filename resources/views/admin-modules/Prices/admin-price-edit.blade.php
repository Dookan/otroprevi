...
<div class="container">
                    ...
                    <div class="form-row border-bottom">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('damage_things') is-invalid @enderror" type="numeric" name="damage_things" id="damage_things" placeholder="Insertar precio" value="{{number_format($price->damage_things,2)}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('premium1') is-invalid @enderror" type="numeric" name="premium1" id="premium1" placeholder="Insertar Precio" value="{{number_format($price->premium1,2)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('damage_people') is-invalid @enderror" type="numeric" name="damage_people" id="damage_people" placeholder="Insertar precio" value="{{number_format($price->damage_people,2)}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('premium2') is-invalid @enderror" type="numeric" name="premium2" id="premium2" placeholder="Insertar Precio" value="{{number_format($price->premium2,2)}}">
                    ...
                    <div class="form-row border-bottom">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('disability') is-invalid @enderror" type="numeric" name="disability" id="disability" placeholder="Insertar precio" value="{{number_format($price->disability, 2)}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('premium3') is-invalid @enderror" type="numeric" name="premium3" id="premium3" placeholder="Insertar Precio" value="{{number_format($price->premium3,2)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('legal_assistance') is-invalid @enderror" type="numeric" name="legal_assistance" id="legal_assistance" placeholder="Insertar precio" value="{{number_format($price->legal_assistance,2)}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('premium4') is-invalid @enderror" type="numeric" name="premium4" id="premium4" placeholder="Insertar Precio" value="{{number_format($price->premium4,2)}}">
                    ...
                    <div class="form-row border-bottom">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('death') is-invalid @enderror" type="numeric" name="death" id="death" placeholder="Insertar precio" value="{{number_format($price->death,2)}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('premium5') is-invalid @enderror" type="numeric" name="premium5" id="premium5" placeholder="Insertar Precio" value="{{number_format($price->premium5,2)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('medical_expenses') is-invalid @enderror" type="numeric" name="medical_expenses" id="medical_expenses" placeholder="Insertar precio" value="{{number_format($price->medical_expenses,2)}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('premium6') is-invalid @enderror" type="numeric" name="premium6" id="premium6" placeholder="Insertar Precio" value="{{number_format($price->premium6,2)}}">
                    ...
                    <div class="form-row border-bottom">
                        <div class="col-12">            
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control number @error('crane') is-invalid @enderror" type="numeric" name="crane" id="crane" placeholder="Insertar precio" value="{{number_format($price->crane)}}">
   ...
   <script type="text/javascript">
    ...
    const class_id_valid = document.getElementById('vehicle_class');
    ...
    class_id_valid.addEventListener('change', () => {
        if (class_id_valid.value === '') {
            class_id_valid.classList.add('is-invalid');
            if (!notValidated.includes(15)) {
                notValidated.push(15);
            }
        }else {
            class_id_valid.classList.remove('is-invalid');
            class_id_valid.classList.add('is-valid');
