                ...
                <div class="form-row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('description') is-invalid @enderror is-invalid" type="text" name="description" id="description" placeholder="Descricion del precio" value="{{old('description')}}" autofocus>
                ...
                <div class="form-row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select name="vehicle_class" id="vehicle_class" class="form-control @error('vehicle_class') is-invalid @enderror custom-select is-invalid">
