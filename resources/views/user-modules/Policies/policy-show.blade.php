...
<div class="card">
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      <li class="nav-item">
        <a class="nav-link bg-dark active" href="/user/user-exportpdf/{{$policy->id}}" target="blank">Exportar PDF</a>
      </li>
  ...
  <div class="card-body">
   ...
   <div class="row border-bottom border-dark mb-4">
    ...
    <div class="row border-bottom border-dark mb-4">
      <div class="col-6 text-center border-right border-dark">
        <h6><span class="font-weight-bold mr-2">Daños a cosas: </span><span class="prices_se">{{$policy->damage_things}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Daños a personas: </span><span class="prices_se">{{$policy->damage_people}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Asistencia jurídica: </span><span class="prices_se">{{$policy->legal_assistance}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Muerte: </span><span class="prices_se">{{$policy->death}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Invalidez: </span><span class="prices_se">{{$policy->disability}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Gastos médicos: </span><span class="prices_se">{{$policy->medical_expenses}}</span> Bs.S</h6>  
        @if($policy->crane == 0)
        <h6><span class="font-weight-bold mr-2">Grua: </span>No aplica</h6>
        @else
        <h6><span class="font-weight-bold mr-2">Grua: </span><span class="prices_se">{{$policy->crane}}</span> Bs.S</h6>
        @endif       
        <h6 class="mt-4"><span class="font-weight-bold mr-2">Total Cobertura: </span><span class="prices_se">{{$policy->total_all}}</span> Bs.S</h6>
      </div>
      <div class="col-6 text-center">
        <h6><span class="font-weight-bold mr-2">Prima: </span><span class="prices_se">{{$policy->premium1}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Prima: </span><span class="prices_se">{{$policy->premium2}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Prima: </span><span class="prices_se">{{$policy->premium3}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Prima: </span><span class="prices_se">{{$policy->premium4}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Prima: </span><span class="prices_se">{{$policy->premium5}}</span> Bs.S</h6>     
        <h6><span class="font-weight-bold mr-2">Prima: </span><span class="prices_se">{{$policy->premium6}}</span> Bs.S</h6>
        <h6 class="mt-5"><span class="font-weight-bold mr-2">Total Prima: </span><span class="prices_se">{{$policy->total_premium}}</span> Bs.S</h6>     
      </div>
    </div>
